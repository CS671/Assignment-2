...
path_train = '/home/ankit/PycharmProjects/Deep_learning/final_dataset/train'
path_test = '/home/ankit/PycharmProjects/Deep_learning/final_dataset/test'
...
def baseline_model():
    model = Sequential()
    model.add(Conv2D(64, (11, 11), strides=3, padding='same', input_shape=input_shape, activation='relu'))
    model.add(MaxPooling2D((2, 2), strides=2, padding='valid'))
    # model.add(Dropout(0.25))
    model.add(Conv2D(64, (7, 7), strides=2, padding='same', input_shape=input_shape, activation='relu'))
    model.add(MaxPooling2D((2, 2), strides=2, padding='valid'))
    # model.add(Dropout(0.25))
